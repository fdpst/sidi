<template>
    <v-container>
        ...
        <v-row dense>
            <v-col cols="3" md="3" class="pt-3 pl-0 pb-0">
                <h2 class="mb-3 grey--text text--darken-1">FILTROS</h2>
            </v-col>
        </v-row>
            <v-row dense> -->
                <!--<rango-fechas :url="url" v-on:success_query="setIngresoBruto"></rango-fechas>-->
                <!--<v-col cols="3" md="3" class="pt-3 pl-0 pb-0">
                    <v-menu
                        ref="menu"
                        v-model="menu"
                ...
                <v-col cols="12" md="4">
                    <v-btn @click="setIngresoBruto()" depressed rounded color="green" class="white--text">buscar</v-btn>
                    <v-btn @click="clean()" outlined depressed rounded color="green" class="white--text">reiniciar</v-btn>
                </v-col>
            </v-row>
            <v-row dense>
                <v-col cols="12" md="6" class="pt-3 pl-0 pb-0">
                    <div v-show="show_chips" class="text-center">
                        <v-chip class="ma-2" color="green" text-color="white">
                            Ingresos: {{ingreso_bruto.ingreso | format_currency}}
                        </v-chip>

                        <v-chip class="ma-2" color="orange" text-color="white">
                            Gastos: {{ingreso_bruto.gasto | format_currency}}
                        </v-chip> -->

                        <!--<span v-for="(item, index) in ingreso_bruto.gasto_desglosado">
                            <v-chip class="ma-2" color="red" text-color="white">
                                {{index}}: {{item | format_currency}}
                            </v-chip>
                        </span>-->
