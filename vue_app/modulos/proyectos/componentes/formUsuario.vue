<template>
    <v-card flat>
        <v-row dense>
            ...
            <v-col cols="12" md="4">
                <v-autocomplete v-if="!proyecto.usuario_id" dense outlined prepend-icon="mdi-account-search-outline" v-model="proyecto.usuario" :error-messages="
  errors.errors['proyecto.usuario.nombre'] ? errors.errors['proyecto.usuario.nombre'][0] : null
...
" v-model="proyecto.usuario.nombre" label="Nombre y Apellidos" required>
            ...
            <v-col cols="12" md="4">
                <v-text-field dense outlined :error-messages="
  errors.errors['proyecto.usuario.nombre_fiscal']
    ? errors.errors['proyecto.usuario.nombre_fiscal'][0]
    : null
" v-model="proyecto.usuario.nombre_fiscal" label="Nombre Fiscal" required>
                </v-text-field>
            </v-col>
            <v-col cols="12" md="4">
                <v-text-field dense outlined :error-messages="
  errors.errors['proyecto.usuario.cif'] ? errors.errors['proyecto.usuario.cif'][0] : null
" v-model="proyecto.usuario.cif" label="CIF/DNI">
                </v-text-field>
            </v-col>
        </v-row>
        <v-row dense>
            <v-col cols="12" md="4">
                <v-text-field dense outlined :error-messages="
  errors.errors['proyecto.usuario.telefono'] ? errors.errors['proyecto.usuario.telefono'][0] : null
" v-model="proyecto.usuario.telefono" label="Teléfono" :rules="[rules.number_rule]" counter maxlength="9" required>
                </v-text-field>
            </v-col>
            <v-col cols="12" md="4">
                <v-text-field dense outlined :error-messages="
  errors.errors['proyecto.usuario.email'] ? errors.errors['proyecto.usuario.email'][0] : null
" v-model="proyecto.usuario.email" label="Email" required>
        ...
        <v-row dense>
            ...
            <v-col cols="12" md="2">
                <v-text-field dense outlined :error-messages="
  errors.errors['proyecto.usuario.codigo_postal']
    ? errors.errors['proyecto.usuario.codigo_postal'][0]
    : null
" v-model="proyecto.usuario.codigo_postal" label="Codigo Postal" :rules="[rules.number_rule]" counter maxlength="5" required>
                </v-text-field>
            </v-col>
            <v-col cols="12" md="3">
        ...
        <v-row dense>
            <v-col cols="12" md="6" class="mt-2">
                <v-text-field dense outlined :error-messages="
  errors.errors['proyecto.usuario.cuenta'] ? errors.errors['proyecto.usuario.cuenta'][0] : null
" v-model="proyecto.usuario.cuenta" label="Cuenta Bancaria" required></v-text-field>
            </v-col>
            <v-col cols="12" md="6">
